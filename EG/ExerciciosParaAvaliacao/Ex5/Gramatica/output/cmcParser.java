// $ANTLR 3.4 /home/bruno/Documents/MEI/EL/PI/Engenharia-de-Linguagens---Projeto-Integrado/EG/ExerciciosParaAvaliacao/Ex5/Gramatica/cmc.g 2012-06-28 20:58:34
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final cmcParser.cmc_return cmc() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: propriedadesConceito, conceitos, instancias, mapasInstanciaPropDados, propriedadesDados, mapasConceitoPropConceito, mapasConceitos, mapasConceitoPropDados, mapasInstanciaPropConceito
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.propriedadeDados_return propriedadeDados() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: STRING, PROPRIEDADEDADOS
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.propriedadeConceito_return propriedadeConceito() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: STRING, PROPRIEDADECONCEITO
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.mapaConceitos_return mapaConceitos() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: MAPACONCEITOS, ID, STRING, STRING
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.mapaConceitoPropDados_return mapaConceitoPropDados() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: MAPACONCEITOPROPDADOS, tipo, ID, STRING, STRING
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.mapaConceitoPropConceito_return mapaConceitoPropConceito() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: STRING, ID, STRING, MAPACONCEITOPROPCONCEITO, STRING
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.mapaInstanciaPropDados_return mapaInstanciaPropDados() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, ID, MAPAINSTANCIAPROPDADOS, STRING
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final cmcParser.mapaInstanciaPropConceito_return mapaInstanciaPropConceito() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: MAPAINSTANCIAPROPCONCEITO, ID, ID, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
