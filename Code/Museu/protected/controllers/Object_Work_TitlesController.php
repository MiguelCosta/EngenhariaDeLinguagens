...
class Object_Work_TitlesController extends Controller
{
	/**
	...
	{
		$model=new Object_Work_Titles('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Object_Work_Titles']))
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Object_Work_Titles::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='object--work--titles-form')
		{
