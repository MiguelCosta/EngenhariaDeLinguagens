...
class InscriptionsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Inscriptions'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_inscriptions));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Inscriptions');
	...
	{
		$model=new Inscriptions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Inscriptions']))
			$model->attributes=$_GET['Inscriptions'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Inscriptions::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='inscriptions-form')
		{
	...
	
	{
		...
		if(isset($_POST['Inscriptions']))
		{
			$model->attributes=$_POST['Inscriptions'];
			if($model->save())
				$this->redirect(array('/Inscriptions/view','id'=>$model->Object_Work_Record));
		}
