<?php
		...
		$model = Rooms::model()->findByAttributes(array('id_room'=>5));
		...
		//array('label'=>'Eliminar sala', 'url'=>'#', 'linkOptions'=>array( 'submit'=>array( '/rooms/delete', 'id'=>5), 'confirm'=>'Tem a certeza que pretende remover esta sala?' )),
		),
		)
		);
		?>
...
<!-- Sistema de navegação --><br/><br/><hr/>
		...
		WHERE Exhibitionsid_exhibition=3 and Roomsid_room=5)'
		);
