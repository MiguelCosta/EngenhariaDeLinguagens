<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('displayCreator')); ?>:</b>
	<?php echo CHtml::encode($data->displayCreator); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('displayMeasurements')); ?>:</b>
	<?php echo CHtml::encode($data->displayMeasurements); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('displayMaterialsTech')); ?>:</b>
	<?php echo CHtml::encode($data->displayMaterialsTech); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('displayCreationDate')); ?>:</b>
