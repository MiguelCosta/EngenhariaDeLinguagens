	...
	<table style="margin-bottom: 0em">
		<tr>
			<td width="70%"><b><?php echo CHtml::encode($data->getAttributeLabel('id_object_Work_Records')); ?>:</b>
				...
				<?php echo  $data->getRecordType_Link();?></td>
			<?php 
			...
			if(file_exists($s)){
				?>
			<td width="30%" style="text-align: right;"><?php echo CHtml::link(CHtml::imageButton($data->getResources_One(), array('width'=>150)),array('view', 'id'=>$data->id_object_Work_Records));?>
			</td>
			<?php }?>
		</tr>
	</table>
