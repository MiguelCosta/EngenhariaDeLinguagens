...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_subjectTerms'); ?>
		<?php echo $form->textField($model,'id_subjectTerms'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'subjectTerm'); ?>
		<?php echo $form->textField($model,'subjectTerm',array('size'=>60,'maxlength'=>63)); ?>
	</div>
