...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_ownershipPlaces'); ?>
		<?php echo $form->textField($model,'id_ownershipPlaces'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'ownershipPlace'); ?>
		<?php echo $form->textField($model,'ownershipPlace',array('size'=>60,'maxlength'=>63)); ?>
	</div>
