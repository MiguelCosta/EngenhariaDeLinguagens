<div class="form">
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'inscriptions',CHtml::listData(Inscriptions::model()->findAll(),'inscriptions', 'inscriptions'), 
		array('empty'=>'Escolha a legenda...', 'style'=>'width:300px;')); ?>
		<?php echo $form->error($model,'id_inscriptions'); ?>
