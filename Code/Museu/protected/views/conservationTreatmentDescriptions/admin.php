...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('conservation-treatment-descriptions-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Conservation Treatment Descriptions</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'conservation-treatment-descriptions-grid',
