...
<resourceWrap>
    <resourceSet>
        ...
        <resourceViewDescription>Emigrante português lendo um jornal do seu país
    num estaleiro de obras nos subúrbios de Paris, 1967.</resourceViewDescription>
    </resourceSet>
</resourceWrap>
\end{lstlisting}
\end{enumerate}
...
\subsection{Análise das normas internacionais para a catalogação de obras de
arte}
